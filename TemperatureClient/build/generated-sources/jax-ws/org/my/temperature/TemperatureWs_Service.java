 ...
 * 
 */
@WebServiceClient(name = "TemperatureWs", targetNamespace = "http://Temperature.my.org/", wsdlLocation = "http://localhost:8080/TemperatureConvertApp/TemperatureWs?wsdl")
    ...
    extends Service
{
    ...
    private final static QName TEMPERATUREWS_QNAME = new QName("http://Temperature.my.org/", "TemperatureWs");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/TemperatureConvertApp/TemperatureWs?wsdl");
    ...
    public TemperatureWs getTemperatureWsPort() {
        return super.getPort(new QName("http://Temperature.my.org/", "TemperatureWsPort"), TemperatureWs.class);
    }
    ...
    public TemperatureWs getTemperatureWsPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://Temperature.my.org/", "TemperatureWsPort"), TemperatureWs.class, features);
    }
